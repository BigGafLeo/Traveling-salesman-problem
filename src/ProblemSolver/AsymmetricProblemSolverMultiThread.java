...
import ProblemSolver.ProblemSolverMultiThread;
import Structure.Matrix;

public class AsymmetricProblemSolverMultiThread extends ProblemSolverMultiThread {

	public AsymmetricProblemSolverMultiThread(Matrix matrix) {
		super(matrix);
	}

	public AsymmetricProblemSolverMultiThread(ProblemSolverMultiThread problemSolver, int k, int b) {
		super(problemSolver, k, b);
	}
